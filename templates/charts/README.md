...
This directory contains the standardized SVG visualization templates used by Nichecraft — charts, infographics, process diagrams, relationship diagrams, and strategic frameworks. The directory name `charts/` is kept for backward compatibility; the library scope is broader than charts.
