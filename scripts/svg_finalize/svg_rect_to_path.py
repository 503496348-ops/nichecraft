#!/usr/bin/env python3
"""
Nichecraft - SVG Rounded Rectangle to Path Tool
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description='Nichecraft - SVG Rounded Rectangle to Path Tool',
...
'''
    ...
    if not quiet:
        print("Nichecraft - SVG Rounded Rectangle to Path Tool")
        print("=" * 50)
